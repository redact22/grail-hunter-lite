    ...
    <div className="max-w-lg mx-auto flex flex-col h-[60vh]">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {SUGGESTIONS.map((s) => (
                <button
                  ...
                  className="hv-btn px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-[11px] font-bold text-white/60 hover:text-white/80 hover:border-white/20 hover:scale-105 active:scale-95 transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#2BF3C0] focus-visible:outline-offset-2"
                >
                  {s}
                </button>
              ))}
      ...
      <div className="flex gap-3">
        <input
          ...
          className="flex-1 px-5 py-4 bg-white/5 border border-white/10 rounded-2xl text-white text-sm placeholder:text-white/30 focus:outline-none focus:border-[#2BF3C0]/40"
        />
        <button
          onClick={() => handleSend()}
          disabled={loading}
